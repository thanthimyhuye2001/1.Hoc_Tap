...
# Xây dựng chương trình quản lý đầu vào đầu ra:
#	 file->file: Thực hiện phép toán (+,-,*,/) với số lớn nhập từ file
#    Bài toán: Tìm ma trận nghịch đảo bằng phương pháp Gauss-Jordan
...
def TimPhanTuGiai():
    ...
    if maxvalue != 0:  # Lưu vị trí hàng và cột của phần tử giải
        ...
        with open(output, "w", encoding="utf-8") as ff:
            ff.write("Ma trận không khả nghịch!!!")         
        quit()            
...
np.savetxt('output.txt', e, fmt='%.5f')
#========================================================================================
# Kiểm tra
print('\n=================================================================')
print('Kiểm tra lại:\n')
